...
namespace Examples
{
    public class shaders_fog
    {
        public static int Main()
        {
            ...
            SetShaderValue(shader, fogDensityLoc, ref, UNIFORM_FLOAT);
            ...
            while (!WindowShouldClose())            // Detect window close button or ESC key
            {
                ...
                SetShaderValue(shader, shader.locs[LOC_VECTOR_VIEW], ref.position.x, UNIFORM_VEC3);
                //----------------------------------------------------------------------------------
                ...
                DrawModel(modelB, new Vector3(-2.6, 0, 0), 1.0f, WHITE);
                DrawModel(modelC, new Vector3(2.6, 0, 0), 1.0f, WHITE);
